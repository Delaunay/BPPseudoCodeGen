...
class Controller_StingerElite(BP_EnemyController):
    mBlackboardAsset = Namespace(AssetPath='/Game/FactoryGame/Character/Creature/Enemy/Stinger/AI/BB_Stinger.BB_Stinger')
    mBehaviorTree = Namespace(AssetPath='/Game/FactoryGame/Character/Creature/Enemy/Stinger/BigStinger/BT_StingerElite.BT_StingerElite')
    ...
    mAttackPattern = ['/Game/FactoryGame/Character/Creature/Enemy/Stinger/Attack_StingerJump.Attack_StingerJump_C', '/Game/FactoryGame/Character/Creature/Enemy/Stinger/Attack_StingerSwipe.Attack_StingerSwipe_C', '/Game/FactoryGame/Character/Creature/Enemy/Stinger/Attack_StingerJump.Attack_StingerJump_C']
    mPanicIgnoreTime = 3
