...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.AlternativeSpitter.BP_SpitterMeleeAlt import ExecuteUbergraph_BP_SpitterMeleeAlt.K2Node_CustomEvent_PSystem
...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.AlternativeSpitter.BP_SpitterMeleeAlt import ExecuteUbergraph_BP_SpitterMeleeAlt.K2Node_Event_OtherActor
...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.AlternativeSpitter.BP_SpitterMeleeAlt import ExecuteUbergraph_BP_SpitterMeleeAlt
...
class BP_SpitterMeleeAlt(FGProjectile):
    ...
    def ReceiveBeginPlay(self):
        self.ExecuteUbergraph_BP_SpitterMeleeAlt(144)
    

    def ReceiveActorBeginOverlap(self):
        ExecuteUbergraph_BP_SpitterMeleeAlt.K2Node_Event_OtherActor = OtherActor #  PERSISTENT_FRAME(
        self.ExecuteUbergraph_BP_SpitterMeleeAlt(231)
    

    def DestroyOnParticleDone(self, PSystem: Ptr[ParticleSystemComponent]):
        ExecuteUbergraph_BP_SpitterMeleeAlt.K2Node_CustomEvent_PSystem = PSystem #  PERSISTENT_FRAME(
        self.ExecuteUbergraph_BP_SpitterMeleeAlt(783)
    

    def ExecuteUbergraph_BP_SpitterMeleeAlt(self):
        ...
        Default__KismetSystemLibrary.Delay(self, 0, LatentActionInfo(Linkage = 129, UUID = -997467114, ExecutionFunction = "ExecuteUbergraph_BP_SpitterMeleeAlt", CallbackTarget = self))
        goto(ExecutionFlow.Pop())
