...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.AlternativeSpitter.BP_SpitterProjectileSplitAlt import ExecuteUbergraph_BP_SpitterProjectileSplitAlt
...
class BP_SpitterProjectileSplitAlt(FGProjectile):
    ...
    def ReceiveBeginPlay(self):
        self.ExecuteUbergraph_BP_SpitterProjectileSplitAlt(10)
    

    def PlayExplosionEffects(self):
        self.ExecuteUbergraph_BP_SpitterProjectileSplitAlt(730)
    

    def ExecuteUbergraph_BP_SpitterProjectileSplitAlt(self):
        ...
        ReturnValue_5.SetVectorParameter("Color", Vector(0, 5, 3))
        goto('L218')
        goto('L378')
