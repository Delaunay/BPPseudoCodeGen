...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.AlternativeSpitter.Controller_Spitter_Alternative import ExecuteUbergraph_Controller_Spitter_Alternative.K2Node_ComponentBoundEvent_Stimulus
from Script.FactoryGame import CanSeeActor
from Script.AIModule import Default__AIBlueprintHelperLibrary
from Game.FactoryGame.Character.Creature.Enemy.Spitter.AlternativeSpitter.Controller_Spitter_Alternative import ExecuteUbergraph_Controller_Spitter_Alternative
from Script.AIModule import SetValueAsBool
from Script.Engine import EqualEqual_NameName
from Game.FactoryGame.Character.Creature.Enemy.Spitter.AlternativeSpitter.Controller_Spitter_Alternative import ExecuteUbergraph_Controller_Spitter_Alternative.K2Node_ComponentBoundEvent_Actor
from Script.FactoryGame import FGAggroTargetInterface

class Controller_Spitter_Alternative(BP_EnemyController):
    ...
    mBehaviorTree = Namespace(AssetPath='/Game/FactoryGame/Character/Creature/Enemy/Spitter/AlternativeSpitter/BT_Spitter_Alternative.BT_Spitter_Alternative')
    ...
    def BndEvt__PerceptionComponent_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature(self, Actor: Ptr[Actor], Stimulus: AIStimulus):
        ExecuteUbergraph_Controller_Spitter_Alternative.K2Node_ComponentBoundEvent_Actor = Actor #  PERSISTENT_FRAME(
        ExecuteUbergraph_Controller_Spitter_Alternative.K2Node_ComponentBoundEvent_Stimulus = Stimulus #  PERSISTENT_FRAME(
        self.ExecuteUbergraph_Controller_Spitter_Alternative(10)
    

    def ExecuteUbergraph_Controller_Spitter_Alternative(self):
