...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.BP_SpitterProjectileVolley import ExecuteUbergraph_BP_SpitterProjectileVolley
from Script.AkAudio import AkComponent
from Script.FactoryGame import FGProjectile

class BP_SpitterProjectileVolley(FGProjectile):
    mProjectileData = Namespace(CanTriggerExplodeBySameClass=True, DamageType='/Game/FactoryGame/Character/Creature/Enemy/Spitter/DamageType_SpitterProjectile.DamageType_SpitterProjectile_C', DamageTypeExplode='/Script/FactoryGame.FGDamageType', ExplodeAtEndOfLife=False, ExplosionDamage=20, ExplosionRadius=300, ImpactDamage=10, ProjectileClass='/Game/FactoryGame/Character/Creature/Enemy/Spitter/BP_SpitterProjectileVolley.BP_SpitterProjectileVolley_C', ProjectileLifeSpan=10, ProjectileStickSpan=0, ShouldExplodeOnImpact=True)
    ...
    mProjectileMovement = Namespace(InitialSpeed=2000, MaxSpeed=4000, ObjectClass='/Script/Engine.ProjectileMovementComponent', ObjectFlags=2883617, ObjectName='ProjectileComp', ProjectileGravityScale=0.20000000298023224, Velocity={'X': 0, 'Y': 0, 'Z': 1}, bRotationFollowsVelocity=True)
    ...
    def ReceiveBeginPlay(self):
        self.ExecuteUbergraph_BP_SpitterProjectileVolley(10)
    

    def PlayExplosionEffects(self):
        self.ExecuteUbergraph_BP_SpitterProjectileVolley(672)
    

    def ExecuteUbergraph_BP_SpitterProjectileVolley(self):
