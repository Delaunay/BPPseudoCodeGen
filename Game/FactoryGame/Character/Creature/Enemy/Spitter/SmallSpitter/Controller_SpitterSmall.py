...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.SmallSpitter.Controller_SpitterSmall import ExecuteUbergraph_Controller_SpitterSmall.K2Node_ComponentBoundEvent_Actor
from Script.AIModule import GetBlackboard
from Game.FactoryGame.Character.Creature.Enemy.Spitter.SmallSpitter.Controller_SpitterSmall import ExecuteUbergraph_Controller_SpitterSmall
...
from Game.FactoryGame.Character.Creature.Enemy.Spitter.SmallSpitter.Controller_SpitterSmall import ExecuteUbergraph_Controller_SpitterSmall.K2Node_ComponentBoundEvent_Stimulus
from Script.FactoryGame import FGAggroTargetInterface

class Controller_SpitterSmall(BP_EnemyController):
    ...
    mBehaviorTree = Namespace(AssetPath='/Game/FactoryGame/Character/Creature/Enemy/Spitter/SmallSpitter/BT_SpitterSmall.BT_SpitterSmall')
    ...
    def BndEvt__PerceptionComponent_K2Node_ComponentBoundEvent_0_ActorPerceptionUpdatedDelegate__DelegateSignature(self, Actor: Ptr[Actor], Stimulus: AIStimulus):
        ExecuteUbergraph_Controller_SpitterSmall.K2Node_ComponentBoundEvent_Actor = Actor #  PERSISTENT_FRAME(
        ExecuteUbergraph_Controller_SpitterSmall.K2Node_ComponentBoundEvent_Stimulus = Stimulus #  PERSISTENT_FRAME(
        self.ExecuteUbergraph_Controller_SpitterSmall(10)
    

    def ExecuteUbergraph_Controller_SpitterSmall(self):
