...
from Game.FactoryGame.Interface.UI.InGame.ColorPicker.Widget_ValueSlider import ExecuteUbergraph_Widget_ValueSlider.K2Node_ComponentBoundEvent_CommitMethod
from Script.Engine import Conv_StringToInt
from Script.Engine import Default__KismetStringLibrary
from Script.UMG import DrawLine
from Script.UMG import UserWidget
from Game.FactoryGame.Interface.UI.InGame.ColorPicker.Widget_ValueSlider import ExecuteUbergraph_Widget_ValueSlider
from Game.FactoryGame.Interface.UI.InGame.ColorPicker.Widget_ValueSlider import ExecuteUbergraph_Widget_ValueSlider.K2Node_ComponentBoundEvent_Text
from Script.CoreUObject import Vector2D
from Game.FactoryGame.Interface.UI.InGame.ColorPicker.Widget_ValueSlider import ExecuteUbergraph_Widget_ValueSlider.K2Node_ComponentBoundEvent_Value
from Script.CoreUObject import LinearColor

class Widget_ValueSlider(UserWidget):
    ...
    def GetSliderValue(self):
        ...
        if not ReturnValue:
            goto('L119')
        ReturnValue_0: float = self.mColorPicker.mValueValue
        goto('L142')
        # Label 119
        ReturnValue_0 = 0
    ...
    def GetInputText(self):
        ...
        if not ReturnValue:
            goto('L202')
        ReturnValue_0: FText = Default__KismetTextLibrary.Conv_FloatToText(self.mColorPicker.mValueValue, 0, False, True, 1, 1, 3, 3)
    ...
    def OnPaint(self):
        ...
        ReturnValue_6: LinearColor = HSVToRGB(self.mColorPicker.mHueValue, self.mColorPicker.mSaturationValue, ReturnValue1, 1)
    ...
    def BndEvt__Slider_0_K2Node_ComponentBoundEvent_109_OnFloatValueChangedEvent__DelegateSignature(self, Value: float):
        ExecuteUbergraph_Widget_ValueSlider.K2Node_ComponentBoundEvent_Value = Value #  PERSISTENT_FRAME(
        self.ExecuteUbergraph_Widget_ValueSlider(10)
    ...
    def BndEvt__mInputText_K2Node_ComponentBoundEvent_270_OnEditableTextBoxCommittedEvent__DelegateSignature(self, text: Const[Ref[FText]], CommitMethod: uint8):
        ExecuteUbergraph_Widget_ValueSlider.K2Node_ComponentBoundEvent_Text = text #  PERSISTENT_FRAME(
        ExecuteUbergraph_Widget_ValueSlider.K2Node_ComponentBoundEvent_CommitMethod = CommitMethod #  PERSISTENT_FRAME(
        self.ExecuteUbergraph_Widget_ValueSlider(132)
    

    def ExecuteUbergraph_Widget_ValueSlider(self):
        ReturnValue1: float = FMax(Value, self.mColorPicker.mShadeExtremeCutoff)
        self.mColorPicker.mValueValue = ReturnValue1
        # End
        ...
        self.mColorPicker.mValueValue = ReturnValue_3
