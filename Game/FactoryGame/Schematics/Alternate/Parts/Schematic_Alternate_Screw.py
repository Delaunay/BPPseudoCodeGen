...
class Schematic_Alternate_Screw(FGSchematic):
    mType = ESchematicType::EST_Alternate
    mDisplayName = NSLOCTEXT("", "D45E3FC44B1CBE5A65974FA1FEA1541E", "Alternate: Casted Screw")
    mSchematicCategory = NewObject[SC_Logistics]()
    mTechTier = 1
    mUnlocks = [{'$ObjectClass': '/Game/FactoryGame/Unlocks/BP_UnlockRecipe.BP_UnlockRecipe_C', '$ObjectFlags': 2621440, '$ObjectName': 'BP_UnlockRecipe_C_0', 'mRecipes': ['/Game/FactoryGame/Recipes/AlternateRecipes/Parts/Recipe_Alternate_Screw.Recipe_Alternate_Screw_C']}]
