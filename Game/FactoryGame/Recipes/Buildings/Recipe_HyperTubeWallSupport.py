...
class Recipe_HyperTubeWallSupport(FGRecipe):
    ...
    mProduct = [{'ItemClass': '/Game/FactoryGame/Buildable/Factory/HyperTubeWallSupport/Desc_HyperTubeWallSupport.Desc_HyperTubeWallSupport_C', 'amount': 1}]
