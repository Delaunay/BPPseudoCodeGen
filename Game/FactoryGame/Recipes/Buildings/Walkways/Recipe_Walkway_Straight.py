...
class Recipe_Walkway_Straight(FGRecipe):
    ...
    mProduct = [{'ItemClass': '/Game/FactoryGame/Buildable/Building/Walkway/Desc_WalkwayStraight.Desc_WalkwayStraight_C', 'amount': 1}]
