...
class Recipe_HyperPoleStackable(FGRecipe):
    ...
    mProduct = [{'ItemClass': '/Game/FactoryGame/Buildable/Factory/PipelineSupport/Desc_HyperPoleStackable.Desc_HyperPoleStackable_C', 'amount': 1}]
