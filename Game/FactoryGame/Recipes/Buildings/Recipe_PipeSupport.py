...
class Recipe_PipeSupport(FGRecipe):
    ...
    mProduct = [{'ItemClass': '/Game/FactoryGame/Buildable/Factory/PipelineSupport/Desc_PipelineSupport.Desc_PipelineSupport_C', 'amount': 1}]
