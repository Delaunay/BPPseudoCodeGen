...
class Recipe_PipeHyperSupport(FGRecipe):
    ...
    mProduct = [{'ItemClass': '/Game/FactoryGame/Buildable/Factory/PipeHyperSupport/Desc_PipeHyperSupport.Desc_PipeHyperSupport_C', 'amount': 1}]
