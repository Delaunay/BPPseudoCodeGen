...
class Desc_ConveyorLiftMk1(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_ConveyorLiftMk1]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk1/UI/ConveyorLiftMK1_256.ConveyorLiftMK1_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk1/UI/ConveyorLiftMK1_512.ConveyorLiftMK1_512')
