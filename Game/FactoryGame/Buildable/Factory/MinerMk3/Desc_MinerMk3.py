...
class Desc_MinerMk3(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_MinerMk3]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/MinerMk3/UI/MinerMk3_256.MinerMk3_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/MinerMk3/UI/MinerMk3_512.MinerMk3_512')
