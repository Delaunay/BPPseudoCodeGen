...
class Desc_PipeStorageTank(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_PipeStorageTank]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/StorageTank/UI/FluidStorage_256.FluidStorage_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/StorageTank/UI/FluidStorage_512.FluidStorage_512')
