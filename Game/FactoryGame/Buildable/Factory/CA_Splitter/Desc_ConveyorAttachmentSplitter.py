...
class Desc_ConveyorAttachmentSplitter(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_ConveyorAttachmentSplitter]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/CA_Splitter/UI/ConveyorSplitter_256.ConveyorSplitter_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/CA_Splitter/UI/ConveyorSplitter_512.ConveyorSplitter_512')
