...
class Desc_StoragePlayer(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_StoragePlayer]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/StoragePlayer/UI/PlayerStorage_256.PlayerStorage_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/StoragePlayer/UI/PlayerStorage_256.PlayerStorage_256')
