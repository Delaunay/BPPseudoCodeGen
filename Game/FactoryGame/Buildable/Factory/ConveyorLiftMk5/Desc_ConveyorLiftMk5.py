...
class Desc_ConveyorLiftMk5(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_ConveyorLiftMk5]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk5/UI/ConveyorLiftMK5_256.ConveyorLiftMK5_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk5/UI/ConveyorLiftMK5_512.ConveyorLiftMK5_512')
