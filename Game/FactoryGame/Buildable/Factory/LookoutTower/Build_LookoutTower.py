...
class Build_LookoutTower(FGBuildableFactory):
    ...
    mDisplayName = NSLOCTEXT("", "7BC4EE4E49ED77007D865BA9B36461A3", "Lookout Tower")
    mDescription = NSLOCTEXT("", "CE29266B483DB00456649FA7C64E8D3B", "Provides a good OVERVIEW useful for building.")
    MaxRenderDistance = -1
