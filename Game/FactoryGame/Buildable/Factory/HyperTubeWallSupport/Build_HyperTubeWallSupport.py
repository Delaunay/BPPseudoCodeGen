...
class Build_HyperTubeWallSupport(FGBuildable):
    mHologramClass = NewObject[Holo_PipelineSupportWall]()
    mDisplayName = NSLOCTEXT("", "3D828D9D481A398EA2A2B69D0291984A", "Hyper Tube Wall Support")
    mDescription = NSLOCTEXT("", "43231B814609DE9C6264529086794FBE", "Can be attached to walls. \r\nSupports for Hyper Tubes to allow for longer distances.")
    MaxRenderDistance = -1
