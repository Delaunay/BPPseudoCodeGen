...
class Desc_WorkBench(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_WorkBench]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/WorkBench/UI/Workbench_256.Workbench_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/WorkBench/UI/Workbench_512.Workbench_512')
