...
class Desc_ConveyorLiftMk4(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_ConveyorLiftMk4]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk4/UI/ConveyorLiftMK4_256.ConveyorLiftMK4_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk4/UI/ConveyorLiftMK4_512.ConveyorLiftMK4_512')
