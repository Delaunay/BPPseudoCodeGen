...
class Desc_ConveyorLiftMk2(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_ConveyorLiftMk2]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk2/UI/ConveyorLiftMK2_256.ConveyorLiftMK2_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/ConveyorLiftMk2/UI/ConveyorLiftMK2_512.ConveyorLiftMK2_512')
