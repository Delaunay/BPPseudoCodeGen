...
from Script.FactoryGame import FGBuildableAutomatedWorkBench

class Build_AutomatedWorkBench(FGBuildableAutomatedWorkBench):
    mInputInventorySize = 4
    ...
    mDisplayName = NSLOCTEXT("", "9494FBCC4487FA53BA5E6EA848992876", "Automated Work bench")
    mDescription = NSLOCTEXT("", "430CE48E4F7019296369E18B0DE30545", "text here")
    MaxRenderDistance = -1
