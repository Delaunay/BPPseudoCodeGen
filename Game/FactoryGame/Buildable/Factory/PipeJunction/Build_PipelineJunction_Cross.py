...
from Game.FactoryGame.Buildable.Factory.PipeJunction.Build_PipelineJunction_Cross import ExecuteUbergraph_Build_PipelineJunction_Cross
from Script.AkAudio import PostAkEvent
from Script.FactoryGame import FGBuildablePipelineJunction
...
class Build_PipelineJunction_Cross(FGBuildablePipelineJunction):
    mRadius = 65
    ...
    mHologramClass = NewObject[FGPipelineJunctionHologram]()
    mDisplayName = NSLOCTEXT("", "4841474A4998580837B45AB5CA652833", "Pipeline Junction Cross")
    mDescription = NSLOCTEXT("", "08F950CD4421E5719EC9A99350B40B50", "Can be attached to a pipeline to split it 4-way.")
    MaxRenderDistance = -1
    ...
    def PlayConstructSound_1(self):
        self.ExecuteUbergraph_Build_PipelineJunction_Cross(10)
    

    def ExecuteUbergraph_Build_PipelineJunction_Cross(self):
