...
class Desc_ConveyorAttachmentSplitterProgrammable(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_ConveyorAttachmentSplitterProgrammable]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/CA_SplitterProgrammable/UI/ProgrammableSplitter_256.ProgrammableSplitter_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/CA_SplitterProgrammable/UI/ProgrammableSplitter_512.ProgrammableSplitter_512')
