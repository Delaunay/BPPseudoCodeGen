...
class Desc_PipeHyperStart(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_PipeHyperStart]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/PipeHyperStart/UI/HyperTubeStart_256.HyperTubeStart_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/PipeHyperStart/UI/HyperTubeStart_512.HyperTubeStart_512')
