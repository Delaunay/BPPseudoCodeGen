...
class Desc_Mam(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Mam]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/Mam/UI/MAM_256.MAM_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/Mam/UI/MAM_512.MAM_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/Mam/Mesh/Mam_static.Mam_static')
