...
class Desc_TrainDockingStation(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_TrainDockingStation]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/Train/Station/UI/DockingStation_256.DockingStation_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/Train/Station/UI/DockingStation_512.DockingStation_512')
