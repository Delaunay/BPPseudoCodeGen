...
class Desc_TrainPlatformEmpty(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_TrainPlatformEmpty]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/Train/Station/UI/EmptyPlatform_256.EmptyPlatform_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Factory/Train/Station/UI/EmptyPlatform_512.EmptyPlatform_512')
