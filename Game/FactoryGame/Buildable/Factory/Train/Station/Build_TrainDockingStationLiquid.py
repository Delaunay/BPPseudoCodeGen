...
class Build_TrainDockingStationLiquid(FGBuildableTrainPlatformCargo):
    mPotentialDockers: List[Ptr[Actor]]
    mFreightCargoType = EFreightCargoType::FCT_Liquid
    mStorageSizeX = 1
    mStorageSizeY = 1
    ...
    mDisplayName = NSLOCTEXT("", "B483D1BD4B81B29E63081E91788A24A9", "Fluid Freight Platform")
    mDescription = NSLOCTEXT("", "3B3879F948C43373E6E654804881582B", "As Freight Cars stop this they will either unload or load their goods, depending on what you\'ve set it to.\r\nThe Freight Platform snaps to Railway, each other and Train Stations.")
    MaxRenderDistance = -1
    ...
    mBuildingID = -1
    mInteractWidgetClass = NewObject[BPW_Train_DockingStation_Fluid]()
    mIsUseable = True
    bReplicates = True
    RemoteRole = 1
