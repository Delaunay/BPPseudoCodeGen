...
class Recipe_TrainDockingStation(FGRecipe):
    ...
    mProduct = [{'ItemClass': '/Game/FactoryGame/Buildable/Factory/Train/Station/Desc_TrainDockingStation.Desc_TrainDockingStation_C', 'amount': 1}]
