...
from Game.FactoryGame.Buildable.Factory.Train.Track.Build_RailroadTrackIntegrated import ExecuteUbergraph_Build_RailroadTrackIntegrated
...
class Build_RailroadTrackIntegrated(FGBuildableRailroadTrack):
    ...
    mIsOwnedByPlatform = True
    mHologramClass = NewObject[FGRailroadTrackHologram]()
    mDisplayName = NSLOCTEXT("", "831361E04B97F1639B9EDA9F622B9332", "Integrated Platform Track")
    MaxRenderDistance = -1
    ...
    def PlayConstructSound(self):
        self.ExecuteUbergraph_Build_RailroadTrackIntegrated(10)
    

    def ExecuteUbergraph_Build_RailroadTrackIntegrated(self):
