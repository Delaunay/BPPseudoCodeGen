...
from Script.FactoryGame import FGBuildableConverter

class Build_Converter(FGBuildableConverter):
    mNumberOfIngredientsNeeded = 2
    ...
    mDisplayName = NSLOCTEXT("", "46C9E5EE4968030FF5AA1E8159E67E70", "Converter")
    mDescription = NSLOCTEXT("", "DE58C59941E8DEAE012C5CA8A28749B8", "Converts any 2 raw resources into 1 raw resource of your choosing.                 Requires 40MW of power to operate.                                               Is built using the super rare resource Strange Alien Metal.")
    MaxRenderDistance = -1
