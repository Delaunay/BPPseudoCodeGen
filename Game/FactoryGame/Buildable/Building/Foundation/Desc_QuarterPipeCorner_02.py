...
class Desc_QuarterPipeCorner_02(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_QuarterPipeCorner_02]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/QuarterPipe_Corner_02_256.QuarterPipe_Corner_02_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/QuarterPipe_Corner_02_512.QuarterPipe_Corner_02_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/Mesh/SM_QuarterPipeCorner_02.SM_QuarterPipeCorner_02')
