...
class Desc_QuarterPipe_02(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_QuarterPipe_02]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/QuarterPipe_02_256.QuarterPipe_02_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/QuarterPipe_02_512.QuarterPipe_02_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/Mesh/SM_QuarterPipe_02.SM_QuarterPipe_02')
