...
class Desc_QuarterPipeCorner_03(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_QuarterPipeCorner_03]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/IconDesc_Cnr_QuarterPipe_03_256.IconDesc_Cnr_QuarterPipe_03_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/IconDesc_Cnr_QuarterPipe_03_512.IconDesc_Cnr_QuarterPipe_03_512')
