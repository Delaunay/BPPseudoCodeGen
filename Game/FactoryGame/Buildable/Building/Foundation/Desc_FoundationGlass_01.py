...
class Desc_FoundationGlass_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_FoundationGlass_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Foundation/UI/Foundation_Glass_256.Foundation_Glass_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Foundation/UI/Foundation_Glass_512.Foundation_Glass_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Foundation/Mesh/SM_FoundationGlass_01.SM_FoundationGlass_01')
