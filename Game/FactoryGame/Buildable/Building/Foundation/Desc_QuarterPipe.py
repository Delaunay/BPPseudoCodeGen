...
class Desc_QuarterPipe(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_QuarterPipe]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/QuarterPipe_01_256.QuarterPipe_01_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/QuarterPipe_01_512.QuarterPipe_01_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/Mesh/SM_QuarterPipe_01.SM_QuarterPipe_01')
