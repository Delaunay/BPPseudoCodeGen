...
class Desc_PillarTop(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_PillarTop]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Pillars/UI/Pillar_Top_256.Pillar_Top_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Pillars/UI/Pillar_Top_512.Pillar_Top_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Pillars/Mesh/SM_Pillar_Top.SM_Pillar_Top')
