...
class Desc_PillarBase(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_PillarBase]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Pillars/UI/Pillar_Bottom_256.Pillar_Bottom_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Pillars/UI/Pillar_Bottom_512.Pillar_Bottom_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Pillars/Mesh/SM_Pillar_01.SM_Pillar_01')
