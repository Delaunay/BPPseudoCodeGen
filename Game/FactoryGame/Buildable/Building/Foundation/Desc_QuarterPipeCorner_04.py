...
class Desc_QuarterPipeCorner_04(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_QuarterPipeCorner_04]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/IconDesc_Cnr_QuarterPipe_04_256.IconDesc_Cnr_QuarterPipe_04_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/IconDesc_Cnr_QuarterPipe_04_512.IconDesc_Cnr_QuarterPipe_04_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/Mesh/SM_QuarterPipe_Corner_04.SM_QuarterPipe_Corner_04')
