...
class Desc_Foundation_Frame_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Foundation_Frame_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Foundation/UI/FrameworkFoundation_256.FrameworkFoundation_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Foundation/UI/FrameworkFoundation_512.FrameworkFoundation_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Foundation/Mesh/SM_FoundationFrame_01.SM_FoundationFrame_01')
