...
class Desc_Wall_Door_8x4_03(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_Door_8x4_03]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Door_Right_Orange_256.Wall_Door_Right_Orange_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Door_Right_Orange_512.Wall_Door_Right_Orange_512')
