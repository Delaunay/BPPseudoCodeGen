...
class Build_Wall_Window_8x4_02(FGBuildableWall):
    mWidth = 800
    mHeight = 400
    ...
    mDisplayName = NSLOCTEXT("", "4CE6F66647998B8986E468902A371F07", "Frame Window")
    mDescription = NSLOCTEXT("", "79EB6B9A4615FEB08AD17C84212C6C83", "Snaps to foundations and other walls.\r\nThe windows allow Pioneers to see through the wall.")
    MaxRenderDistance = -1
