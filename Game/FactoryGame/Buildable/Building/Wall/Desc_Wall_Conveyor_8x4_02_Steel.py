...
class Desc_Wall_Conveyor_8x4_02_Steel(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_Conveyor_8x4_02_Steel]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x2_Grey_256.Wall_Conveyor_x2_Grey_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x2_Grey_512.Wall_Conveyor_x2_Grey_512')
