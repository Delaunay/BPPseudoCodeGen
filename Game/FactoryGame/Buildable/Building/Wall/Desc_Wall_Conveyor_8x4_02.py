...
class Desc_Wall_Conveyor_8x4_02(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_Conveyor_8x4_02]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x2_Orange_256.Wall_Conveyor_x2_Orange_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x2_Orange_512.Wall_Conveyor_x2_Orange_512')
