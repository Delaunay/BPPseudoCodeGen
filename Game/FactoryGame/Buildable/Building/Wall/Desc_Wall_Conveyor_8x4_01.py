...
class Desc_Wall_Conveyor_8x4_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_Conveyor_8x4_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x3_Orange_256.Wall_Conveyor_x3_Orange_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x3_Orange_512.Wall_Conveyor_x3_Orange_512')
