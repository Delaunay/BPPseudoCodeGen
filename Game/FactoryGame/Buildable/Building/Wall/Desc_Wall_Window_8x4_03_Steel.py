...
class Desc_Wall_Window_8x4_03_Steel(FGBuildingDescriptor):
    ...
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/Mesh/Placeholder/Wall_02e.Wall_02e')
