...
class Build_Wall_Window_8x4_04(FGBuildableWall):
    mWidth = 800
    mHeight = 400
    ...
    mDisplayName = NSLOCTEXT("", "30B53FD940EE282E9D567B970728F4A4", "Reinforced Window")
    mDescription = NSLOCTEXT("", "3930A95E43046096747130A38DBB42BC", "Snaps to foundations and other walls.\r\nThe windows allow Pioneers to see through the wall.")
    MaxRenderDistance = -1
