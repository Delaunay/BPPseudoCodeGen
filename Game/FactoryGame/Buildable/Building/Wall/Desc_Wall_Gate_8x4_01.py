...
class Desc_Wall_Gate_8x4_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_Gate_8x4_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Orange_Gate_256.Wall_Orange_Gate_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Orange_Gate_512.Wall_Orange_Gate_512')
    mConveyorMesh = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/Mesh/SM_Wall_Door_8x4_04.SM_Wall_Door_8x4_04')
