...
class Desc_Wall_Door_8x4_01_Steel(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_Door_8x4_01_Steel]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Door_Center_Grey_256.Wall_Door_Center_Grey_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Door_Center_Grey_512.Wall_Door_Center_Grey_512')
