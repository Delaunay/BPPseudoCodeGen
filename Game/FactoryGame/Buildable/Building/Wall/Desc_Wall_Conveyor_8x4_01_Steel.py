...
class Desc_Wall_Conveyor_8x4_01_Steel(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_Conveyor_8x4_01_Steel]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x3_Grey_256.Wall_Conveyor_x3_Grey_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Conveyor_x3_Grey_512.Wall_Conveyor_x3_Grey_512')
