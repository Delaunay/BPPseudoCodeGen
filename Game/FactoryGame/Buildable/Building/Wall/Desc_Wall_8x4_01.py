...
class Desc_Wall_8x4_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Wall_8x4_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Orange_256.Wall_Orange_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Wall/UI/Wall_Orange_512.Wall_Orange_512')
