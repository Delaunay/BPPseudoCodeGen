...
class Build_Wall_Window_8x4_01(FGBuildableWall):
    mWidth = 800
    mHeight = 400
    ...
    mDisplayName = NSLOCTEXT("", "9C52F83F42C7DCD3144C67BD4842AA22", "Single Window")
    mDescription = NSLOCTEXT("", "484B97984F80926C68FDC49A8CE2996A", "Snaps to foundations and other walls.\r\nThe window allows Pioneers to see through the wall.")
    MaxRenderDistance = -1
