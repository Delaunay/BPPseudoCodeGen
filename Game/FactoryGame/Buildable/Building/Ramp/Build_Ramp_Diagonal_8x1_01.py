...
class Build_Ramp_Diagonal_8x1_01(FGBuildableFoundation):
    mSize = 800
    mHeight = 100
    ...
    mDisplayName = NSLOCTEXT("", "BD3989FA49528018FDE5EEA2CAEE4490", "Down Corner Ramp 8m x 1m")
    mDescription = NSLOCTEXT("", "2E7FB2884E3E7529864A51A5126334B8", "Ramps make it easier to get up onto Foundations for Pioneers and their Vehicles.\r\nHeight: 1")
    MaxRenderDistance = -1
