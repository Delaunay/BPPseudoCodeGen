...
class Desc_Ramp_8x2_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Ramp_8x2_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/Ramps_small_256.Ramps_small_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/Ramps_small_512.Ramps_small_512')
