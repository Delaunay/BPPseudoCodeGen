...
class Desc_Ramp_Diagonal_8x1_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Ramp_Diagonal_8x1_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/TXUI_Foundation_Corner_8x1_256.TXUI_Foundation_Corner_8x1_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/TXUI_Foundation_Corner_8x1_512.TXUI_Foundation_Corner_8x1_512')
