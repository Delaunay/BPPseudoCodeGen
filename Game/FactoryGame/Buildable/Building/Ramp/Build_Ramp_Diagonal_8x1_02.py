...
class Build_Ramp_Diagonal_8x1_02(FGBuildableFoundation):
    mSize = 800
    mHeight = 100
    ...
    mDisplayName = NSLOCTEXT("", "E3E0F9034BB2FB0A02A1E789888A7070", "Up Corner Ramp 8m x 1m")
    mDescription = NSLOCTEXT("", "556C23BF4679FE7FCCF5BB921C43A045", "Ramps make it easier to get up onto Foundations for Pioneers and their Vehicles.\r\nHeight: 1")
    MaxRenderDistance = -1
