...
class Build_Ramp_Diagonal_8x4_01(FGBuildableFoundation):
    mSize = 800
    mHeight = 400
    ...
    mDisplayName = NSLOCTEXT("", "A0082D7E489CC2721CE3A493940D9F20", "Down Corner Ramp 8m x 4m")
    mDescription = NSLOCTEXT("", "F5BEAC14452CCE2D62E7B7843AC5C2BF", "Ramps make it easier to get up onto Foundations for Pioneers and their Vehicles.\r\nHeight: 4")
    MaxRenderDistance = -1
