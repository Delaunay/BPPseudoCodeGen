...
class Desc_Ramp_Diagonal_8x4_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Ramp_Diagonal_8x4_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/TXUI_Foundation_Corner_8x4_256.TXUI_Foundation_Corner_8x4_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/TXUI_Foundation_Corner_8x4_512.TXUI_Foundation_Corner_8x4_512')
