...
class Desc_Ramp_8x4_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Ramp_8x4_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/Ramps_256.Ramps_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/Ramps_512.Ramps_512')
