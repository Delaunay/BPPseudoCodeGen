...
class Desc_Ramp_Diagonal_8x1_02(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Ramp_Diagonal_8x1_02]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/TXUI_Ramp_Corner_8x1_256.TXUI_Ramp_Corner_8x1_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/TXUI_Ramp_Corner_8x1_512.TXUI_Ramp_Corner_8x1_512')
