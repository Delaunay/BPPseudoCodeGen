...
class Build_Ramp_Diagonal_8x4_02(FGBuildableFoundation):
    mSize = 800
    mHeight = 400
    ...
    mDisplayName = NSLOCTEXT("", "CA0000424131621058A9D2886C7A5D3A", "Up Corner Ramp 8m x 4m")
    mDescription = NSLOCTEXT("", "40FBDAA442E4C218DF06148E2ABEE972", "Ramps make it easier to get up onto Foundations for Pioneers and their Vehicles.\r\nHeight: 4")
    MaxRenderDistance = -1
