...
class Desc_Ramp_8x1_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Ramp_8x1_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/Ramp8x1_256.Ramp8x1_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Ramp/UI/Ramp8x1_512.Ramp8x1_512')
