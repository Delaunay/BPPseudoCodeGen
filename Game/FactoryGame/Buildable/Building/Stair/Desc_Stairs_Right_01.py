...
class Desc_Stairs_Right_01(FGBuildingDescriptor):
    mBuildableClass = NewObject[Build_Stairs_Right_01]()
    ...
    mSmallIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Stair/UI/StairRight_256.StairRight_256')
    mPersistentBigIcon = Namespace(AssetPath='/Game/FactoryGame/Buildable/Building/Stair/UI/StairRight_512.StairRight_512')
